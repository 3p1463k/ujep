...
class Root(Tk):
    ...
    def makmov(self):
        ...
        filewritetxt2.close()
        print('Export slozka: ', pat2fol1)
        print('Import slozka: ', pat2fol2)
        ...
        def read_csv_file():
            ...
            list_of_directories = glob.glob("/home/evzen/doc/kpi/*.csv")
        ...
        def webomat():
            ...
            #cudlik4.click()
            os.system("xfce4-terminal")  # WINDOWS os.system("start /wait cmd /c {command}")
